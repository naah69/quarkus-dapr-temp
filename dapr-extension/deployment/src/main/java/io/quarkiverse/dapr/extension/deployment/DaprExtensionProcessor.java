package io.quarkiverse.dapr.extension.deployment;
...
/**
 * DaprExtensionProcessor
 *
 * @author naah69
 * @date 22022-04-01 17:42:02
 */
class DaprExtensionProcessor {

    private static final Logger log = LoggerFactory.getLogger(DaprExtensionProcessor.class);
